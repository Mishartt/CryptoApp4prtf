...
const CryptoItem:FC<any> = ({coin}:ICoin) => {
    ...
    return(
        <div onClick={more} className="cryptoItem" style={{height:coin.open }}>
            <div style={{display:'flex',alignItems:'center',height:'90%',justifyContent:'space-between',backgroundColor:'transparent',maxHeight:'3vh'}}>
            ...
            <div style={{display:coin.visible,height:'10vh',backgroundColor:'transparent',alignItems:'end',justifyContent:'space-around'}}>
                ...
                <p>Volume24h : <strong style={{color:colorVl}}>{coin.marketcap.volume_turnover_last_24_hours_percent}%</strong></p>
            </div>
        </div>
    )
}
